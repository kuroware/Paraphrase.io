...
<!-- 							<a href ng-repeat="language in languages" ng-class="language.classStyle" ng-click="newSelect(language.language_id)" ng-cloak>{{language.language_name}}<span style="float:right;">
							...
							<div>
								...
								<div style="margin-top:5px;">
									<div ng-repeat="object in data.recentAnnotatedFunctions" style="margin-bottom:5px;" ng-cloak>
										<a ng-href="language.php?id={{object.function.function_language.language_id}}">{{object.function.function_language.language_name}}'s</a>
										<a ng-href="function.php?id={{object.function.function_id}}">{{object.function.function_name}}</a>
										<span class="badge" style="float:right;">{{object.counter}}</span>
									</div>
								</div>
							</div>
						</div>
