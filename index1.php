...
<!-- 				<div class="row">
				...
				<div class="row jumbotron">
					<div class="col-md-12">
						...
						<p style="float:right;">
							{{translationsToday}} searches done today
						</p>
					</div>
					<form>
						<div class="col-md-9">
<!-- 							<angucomplete id="members"
					              placeholder="Function/method/concept in the supported languages to be searched"
					              pause="400"
					              selectedobject="searchCode"
					              ng-model="searchPhrase"
					              url="http://paraphrase.io/postRequests/addFunction/searchFunction.php?function="
					              titlefield="title"
					              descriptionfield = "summary"
					              inputclass="form-control form-control-small" required>
					        </angucomplete> -->
					       <input type="text" ng-model="searchPhrase" class="form-control">
					       <small>
					        	i.e. "strtolower()" or "Sending a $http request in AngularJS"
					        </small>
				        </div>
				        <div class="col-md-2">
				        ...
				        <div class="col-md-1">
				        	<input type="submit" class="btn btn-primary" ng-click="attemptTranslation()" value="Search">
				       	</div>
				       	<div class="col-md-1">
				       		<input type="submit" class="btn btn-info" value="Paraphrase">
				       		<!-- Maybe for possibly quick direction to translation-->
				       	</div>
					</form>
				</div>
				<div class="row">
					<div class="col-md-3" style="min-height:100vh;margin-top:10px;">
						<div class="list-group">
							...
							<div>
								...
								<hr>
								<h4 style="display:inline">Recent Functions</h4>
